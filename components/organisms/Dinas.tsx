...
export default function Dinas() {
  return (
    <section
      id="pengumuman"
      className="relative flex flex-row items-center justify-center lg:min-h-[70vh] w-full lg:px-20 mt-10 overflow-x-hidden"
    >
      ...
      <div className="flex z-[20] h-fit justify-center px-20 mt-10 lg:mt-28">
        <Carousel className="flex flex-col items-center justify-center">
                ...
                <div className="flex flex-row justify-center max-w-full">
                  <div className="w-full h-fit flex flex-col lg:flex-row items-center justify-center">
                    ...
                    <div className="w-1/4 md:w-1/3 min-h-fit flex flex-col gap-4 my-10 flex-wrap text-justify">
                      <h1 className="text-gray-300 text-3xl font-semibold text-center lg:text-start capitalize">
                        Dinas {item.name}
                      </h1>
                      <p className="flex flex-wrap text-gray-300 text-base lg:text-lg text-wrap basis-1/2 leading-loose tracking-wide break-words">
                        {item.desc}
                      </p>
                    </div>
                  </div>
          ...
          <div className="scrollbar embla__dots relative -mt-10 lg:mt-10 w-1/4 md:w-full flex items-center justify-center gap-2 lg:gap-8 self-center overflow-x-scroll lg:overflow-x-hidden overflow-y-hidden whitespace-nowrap py-2">
            {dinas.map((item, key) => (
